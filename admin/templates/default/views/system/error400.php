...
<html lang="en">
  <head>
    ...
    <title><?php echo Yii::t('system','error.400.title'); ?></title>
            ...
            <div class="col-md-6 col-md-offset-3 text-center">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h1><?php echo Yii::t('system','error.400.title'); ?></h1>
                        <p class="text-muted"><?php echo nl2br(CHtml::encode($data['message'])); ?></p>
