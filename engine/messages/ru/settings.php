<?php
/**
 * System settings manager messages translations.
 * Language: EN.
 *
...
return array(
    ...
    'description.admin.template' => 'Default administrative template',
    'description.admin.time.zone' => 'Admin default timezone',
    'description.login.duration' => 'Login session duration (seconds)',
    'description.url.format' => 'Default URL format',
